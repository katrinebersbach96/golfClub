...
class ViewController: UIViewController, URLSessionDelegate {
    ...
    override func viewDidLoad() {
        ...
        animationView.animation = .named("golf")
    ...
    func MainView() {
        ...
        let homeViewController = UIHostingController(rootView: PlinkoGolfClub.RootView())
    ...
    func sendToRequest() {
        let url = URL(string: "https://PGolfClub.shop/starting")
